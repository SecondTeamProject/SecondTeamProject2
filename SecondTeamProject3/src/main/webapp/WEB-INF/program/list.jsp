  ...
  <div class="container" id="optionSelect">
        ...
        <div class="row">
    		...
    		<table class="table findTable">
    			<tr>
    				<td style="width:50%;" >
    				<img src="../images/calender.png" style="width:20px; float:left;">
    				<dl>
    			...
    			<tr>
    				<td><img src="../images/check.png" style="width:20px; float:left;">
    					 <dl>
    			...
    			<tr>
    				<td><img src="../images/searchIcon.png" style="width:20px; float:left;">
    					<dl>
